...
const SidebarItem = ({ item, path }: { item: SideBarItemType, path: string }) => {
    return (
        <Link className="h-14 w-full flex  items-center gap-4" to={item.url}>
            <p className="text-xl font-semibold text-ternary-dark-color w-40">{item.name}</p>
            ...
            <div className="flex flex-col items-center justify-between flex-grow">
                <div className="h-60 flex flex-col justify-center items-center w-full">
                    <div className="w-full relative flex flex-col justify-center items-center h-1/2">
                        <img src={test} alt="user-profile-image" className="rounded-full size-28 z-10" />
                        <div className="h-1 w-10/12 mx-auto bg-ternary-dark-color rounded-xl absolute z-0"></div>
                    </div>
                    <div>
                        <p className="text-3xl font-semibold text-ternary-dark-color">Name</p>
                        <p className="text-lg font-normal text-ternary-dark-color">Description</p>
                    </div>
                </div>
